...
abstract class quiz_attempts_report_table extends table_sql {
    ...
    public function base_sql(\core\dml\sql_join $allowedstudentsjoins) {
        ...
        $extrafields = get_extra_user_fields_sql($this->context, 'u', '',
                array('id', 'idnumber', 'username', 'firstname', 'lastname', 'picture',
        ...
        // filtering for institution by admin and course-admin with same institution.
        if (!empty($USER->institution)) {
            $where .= " AND u.institution = :user_institution";
            $params['user_institution'] = $USER->institution;
        }
