    ...
    public function display($scorm, $cm, $course, $download) {
        ...
        if ( !$nostudents ) {
            ...
            if (!$download) {
                ...
                $table->column_class('username', 'bold');
            ...
            $select .= 'st.scormid AS scormid, st.attempt AS attempt, ' .
                    ...
                    get_extra_user_fields_sql($coursecontext, 'u', '', array('email', 'idnumber', 'username')) . ' ';
            ...
            if (!empty($USER->institution)) {
                $where .= "AND u.institution = '" .$USER->institution. "'";
            }
            ...
            if ($attempts) {
                foreach ($attempts as $scouser) {
                    ...
                    if (!$download) {
                        ...
                        $row[] = \html_writer::link($url, $scouser->userid);
                    } else {
                        $row[] = $scouser->userid;
                    }
                    foreach ($extrafields as $field) {
				    ...
				    $strstatus = formatDuration($trackdata->total_time);
