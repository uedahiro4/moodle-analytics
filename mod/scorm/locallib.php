 ...
 */
/**
 * mod-scorm:locallib.php has been modified by below.
...
function scorm_get_navigation_display_array() {
    return array(SCORM_NAV_DISABLED => get_string('no'),
		 ...
		 SCORM_NAV_UNDER_CONTENT_CHAPTER => get_string('overchapterfix', 'scorm'),
                 SCORM_NAV_FLOATING_CHAPTER => get_string('overchapterfloat', 'scorm'));
}
